...
# --- Define gait phases ---
phase1 = {
    "hr_hip": math.radians(-45), "hr_knee": 0.0,
    "hl_hip": math.radians(-45), "hl_knee": 0.0,
    "fr_hip": math.radians(45),  "fr_knee": math.radians(-90),
    "fl_hip": math.radians(45),  "fl_knee": math.radians(-90)
}
phase2 = {
    "hr_hip": math.radians(45), "hr_knee": 0.0,
    "hl_hip": math.radians(45), "hl_knee": 0.0,
    "fr_hip": 0.0,  "fr_knee": math.radians(-90),
    "fl_hip": 0.0,  "fl_knee": math.radians(-90)
}
phase3 = {
    "hr_hip": math.radians(65), "hr_knee": 0.0,
    "hl_hip": math.radians(65), "hl_knee": 0.0,
    "fr_hip": math.radians(-65),  "fr_knee": 0.0,
    "fl_hip": math.radians(-65),  "fl_knee": 0.0,
}
phase4 = {
    "hr_hip": math.radians(45), "hr_knee": math.radians(45),
    "hl_hip": math.radians(45), "hl_knee": math.radians(45),
    "fr_hip": 0.0,  "fr_knee": 0.0,
    "fl_hip": 0.0,  "fl_knee": 0.0,
}
phase5 = {
    "hr_hip": math.radians(-45), "hr_knee": math.radians(65),
    "hl_hip": math.radians(-45), "hl_knee": math.radians(65),
    "fr_hip": math.radians(45),  "fr_knee": 0.0,
    "fl_hip": math.radians(45),  "fl_knee": 0.0,
}
phase6 = {
    "hr_hip": math.radians(-65), "hr_knee": math.radians(65),
    "hl_hip": math.radians(-65), "hl_knee": math.radians(65),
    "fr_hip": math.radians(65),  "fr_knee": 0.0,
    "fl_hip": math.radians(65),  "fl_knee": 0.0,
}
